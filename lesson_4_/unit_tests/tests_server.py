...
class TestServer(unittest.TestCase):
    ...
    err_format = [RESPONSE, 400,
        ERROR, 'Bad Request']

    ok_dict = {RESPONSE: 200}

    # _________Трудно импровизировать когда все вариации уже протестированы в примере ДЗ, но ..____#
    # _________пришлось немного изменить тестируемую функцию для возможности тестирования возникновения исключения__#
    def test_wrong_format(self):
        """Ошибочный формат - список вместо словаря"""
        self.assertRaises(TypeError, process_client_message, self.err_format)
