...
from data_base import user_login, user_logout, users_list, active_users_list, login_history
    ...
    def process_client_message(self, message, client):
        ...
        if ACTION in message and message[ACTION] == PRESENCE and \
            ...
            if message[USER][ACCOUNT_NAME] not in self.names.keys():
                ...
                user_login(message[USER][ACCOUNT_NAME], client_ip, client_port)
            ...
            user_logout(message[ACCOUNT_NAME])
